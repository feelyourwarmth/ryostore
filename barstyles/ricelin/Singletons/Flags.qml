...
Singleton {
    ...
    FileView {
        ...
        JsonAdapter {
            ...
            /** Explicit wallpaper folder override. Empty follows ryogami.json paths.wallpaper, then ~/Pictures/Wallpapers. Kept in user state across style updates. */
            ...
            property bool gamePrevViz: false
